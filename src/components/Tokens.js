          ...
          {assets.map((asset, index) => (
            ...
            asset.usd_price_24hr_percent_change < 0 && (
              <tr key={asset.token_address}>
                ...
                <td className="px-4 py-2">{numeral(asset.balance_formatted).format('0,0.00')}</td>
                <td className="px-4 py-2">${numeral(asset.usd_price).format('0,0.00')}</td>
                <td className="px-4 py-2" style={{ color: asset.color }}>
                  {numeral(asset.usd_price_24hr_percent_change).format('0,0.00')}%
                </td>
                <td className="px-4 py-2">${numeral(asset.usd_value).format('0,0.00')}</td>
