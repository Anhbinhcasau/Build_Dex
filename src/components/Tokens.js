      ...
      const response = await fetch(
        `https://deep-index.moralis.io/api/v2.2/wallets/0xcB1C1FdE09f811B294172696404e88E658659905/tokens?chain=eth`,
        {
          ...
          headers: {
            ...
            "X-API-Key":
              "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJub25jZSI6IjlhYTVlYmVlLTYxZTAtNDE4MC04Yjc4LTdmY2YyYjY3Y2UzOCIsIm9yZ0lkIjoiMzg1NDg3IiwidXNlcklkIjoiMzk2MDk2IiwidHlwZUlkIjoiNzUzNWQ4Y2MtYTY0Ni00Njg3LWFlY2QtZmFkZjljNmYyMjFiIiwidHlwZSI6IlBST0pFQ1QiLCJpYXQiOjE3MTE4MDE5OTAsImV4cCI6NDg2NzU2MTk5MH0.Rb5aVgUAQX_EB2BJ9GAi0jpCtVr8ldLWNLLeqZfnDnA",
          },
        }
      );
